...
<!-- ye user ko welcome msg dekhany k leye  -->
<?php
...
<div class="sec-banner bg0 p-t-80 p-b-50">
	<div class="container">
		<div class="row">
			...
			<?php $querry = $pdo->query('SELECT * FROM categories LIMIT 3');
			...
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				foreach ($allcategory as $catgeory) {
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						data-filter=".<?php echo $catgeory['id']?>">
...
<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product['Category_Id']?>">
	...
	<div class="block2">
		<div class="block2-pic hov-img0">
			<img src="adminpanel/Product_Images/<?php echo $product['Image']?>" alt="IMG-PRODUCT">
